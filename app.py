...
def show_venue(venue_id):
  ...
  venue["past_shows"] = Show.query.filter(Show.venue_id == venue_id, Show.start_time < datetime.now()).all()
  venue["past_shows_count"] = len(venue["past_shows"])
  venue["upcoming_shows"] = Show.query.filter(Show.venue_id == venue_id, Show.start_time >= datetime.now()).all()
...
def show_artist(artist_id):
  ...
  artist["past_shows"] = Show.query.filter(Show.artist_id == artist_id, Show.start_time < datetime.now()).all()
  artist["past_shows_count"] = len(artist["past_shows"])
  artist["upcoming_shows"] = Show.query.filter(Show.artist_id == artist_id, Show.start_time >= datetime.now()).all()
